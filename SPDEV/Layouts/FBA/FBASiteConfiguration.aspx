...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FBASiteConfiguration.aspx.cs"
    Inherits="Sharepoint.FormsBasedAuthentication.FBASiteConfiguration" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    <table border="0" width="100%" cellspacing="0" cellpadding="0" class="ms-descriptiontext">
        ...
        <wssuc:InputFormSection runat="server" Title="<% $Resources:MyResource,WeChatConfig%>">
            <template_description>
		        <SharePoint:EncodedLiteral ID="WeChatConfigDesc" runat="server" text="<% $Resources: MyResource, WeChatConfigDesc%>" EncodeMethod='HtmlEncode'/>
	        </template_description>
            <template_inputformcontrols>

             <wssuc:InputFormControl runat="server" LabelText="<% $Resources: MyResource, WeChatServiceAppID %>">
			    <Template_Control>
                    <SharePoint:InputFormTextBox Title="<% $Resources: MyResource, WeChatServiceAppID %>" class="ms-input" Columns="40" maxlength="255" ID="WeChatServiceAppID" Direction="LeftToRight" Runat="server" Enabled="True" />
                </Template_Control>
		    </wssuc:InputFormControl>

                <wssuc:InputFormControl runat="server" LabelText="<% $Resources: MyResource, WeChatServiceUrl %>">
			    <Template_Control>
                    <SharePoint:InputFormTextBox Title="<% $Resources: MyResource, WeChatServiceUrl %>" class="ms-input" Columns="40" maxlength="255" ID="WeChatServiceUrl" Direction="LeftToRight" Runat="server" Enabled="false"   />
                </Template_Control>
		    </wssuc:InputFormControl>
                <wssuc:InputFormControl runat="server" LabelText="<% $Resources: MyResource, WeChatServiceToken %>">
			    <Template_Control>
                    <SharePoint:InputFormTextBox Title="<% $Resources: MyResource, WeChatServiceToken %>" class="ms-input" Columns="40" maxlength="255" ID="WeChatServiceToken" Direction="LeftToRight" Runat="server" Enabled="True" />
                </Template_Control>

		    </wssuc:InputFormControl>
                
             <wssuc:InputFormControl runat="server" LabelText="<% $Resources: MyResource, WeChatServiceEncodingAESKey %>">
			    <Template_Control>
                    <SharePoint:InputFormTextBox Title="<% $Resources: MyResource, WeChatServiceEncodingAESKey %>" class="ms-input" Columns="40" maxlength="255" ID="WeChatServiceEncodingAESKey" Direction="LeftToRight" Runat="server" Enabled="True" />
                </Template_Control>
		    </wssuc:InputFormControl>
