...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IForgetMyPassword.aspx.cs" Inherits="Sharepoint.FormsBasedAuthentication.IForgetMyPassword"
...
<%--    <script type="text/javascript"  charset="utf-8"
    ...
    <style>
        div.s4-simple-iconcont img {
            display: none;
            F: \SP2010Customization\SPDEV\SPDEV\Layouts\FBA\IForgetMyPassword.aspx;
        }
...
<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolderPageTitle" runat="server">
    <SharePoint:EncodedLiteral ID="PageTitle" Text="<%$ Resources:MyResource, IForgetMyPassword %>"
...
<%--   	<a href="../../settings.aspx"><SharePoint:EncodedLiteral ID="EncodedLiteral1" runat="server" text="<%$Resources:wss,settings_pagetitle%>" EncodeMethod="HtmlEncode"/></a>&#32;<SharePoint:ClusteredDirectionalSeparatorArrow ID="ClusteredDirectionalSeparatorArrow1" runat="server" />
    ...
    <SharePoint:EncodedLiteral ID="TitleArea" Text="<%$Resources:MyResource, IForgetMyPassword%>"
        EncodeMethod="HtmlEncode" runat="server" />
</asp:Content>
...
<%--        <wssuc:InputFormSection runat="server" id="EmailSection" Title="<%$ Resources:FBAPackWebPages, SendEmailHeaderText %>">
        ...
        <!-- Buttons -->
        <%--<SharePoint:EncodedLiteral ID="EncodedLiteralSendEmail" runat="server" text="<%$Resources:MyResource,SendEmailToActivateAccount%>" EncodeMethod='HtmlEncode'/>--%>
        <asp:Label ID="lblSendEmail" runat="server" Text="<%$Resources:MyResource,IForgetMyPasswordUseEmailToReset%>"></asp:Label>
        <br/>
        <asp:Label ID="lblMessage" runat="server" Text="" ForeColor="red"></asp:Label>
        <br/>
