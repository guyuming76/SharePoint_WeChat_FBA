...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserActivate.aspx.cs" Inherits="Sharepoint.FormsBasedAuthentication.UserActivate"
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" class="ms-descriptiontext">
        ...
        <wssuc:InputFormSection runat="server" Title="<%$ Resources:FBAPackWebPages, EmailColHeaderText %>">
		    ...
		    <wssuc:InputFormControl runat="server" LabelText="<%$ Resources:FBAPackWebPages, TypeEmailAddrLabelText %>">
			    <Template_Control>
			    <SharePoint:InputFormTextBox Title="<%$ Resources:FBAPackWebPages, EmailColHeaderText %>" class="ms-input" Columns="40" maxlength="255" ID="txtEmail" Direction="LeftToRight" Runat="server" Enabled="false" ReadOnly="true" />
