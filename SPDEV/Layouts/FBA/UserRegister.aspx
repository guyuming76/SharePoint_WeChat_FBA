...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRegister.aspx.cs" Inherits="Sharepoint.FormsBasedAuthentication.UserRegister"
...
<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolderPageTitle" runat="server">
    <SharePoint:EncodedLiteral ID="PageTitle" Text="<%$ Resources:MyResource, RegisterNewUser %>"
...
<%--   	<a href="../../settings.aspx"><SharePoint:EncodedLiteral ID="EncodedLiteral1" runat="server" text="<%$Resources:wss,settings_pagetitle%>" EncodeMethod="HtmlEncode"/></a>&#32;<SharePoint:ClusteredDirectionalSeparatorArrow ID="ClusteredDirectionalSeparatorArrow1" runat="server" />
    ...
    <SharePoint:EncodedLiteral ID="TitleArea" Text="<%$Resources:MyResource, RegisterNewUser%>"
        EncodeMethod="HtmlEncode" runat="server" />
</asp:Content>
...
<%--        <wssuc:InputFormSection runat="server" id="EmailSection" Title="<%$ Resources:FBAPackWebPages, SendEmailHeaderText %>">
        ...
        <asp:Label ID="lblSendEmail" runat="server" Text="<%$Resources:MyResource,SendEmailToActivateAccount%>"></asp:Label>
        <br/>
