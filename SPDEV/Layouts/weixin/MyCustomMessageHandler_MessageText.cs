...
namespace weixin
{
    ...
    + "系统根据您的WeiXinOpenId在电脑网站(" + serverUrl + ") 生成用户名:" + SPFBAUserName + System.Environment.NewLine
    ...
    + "System created username " + SPFBAUserName + " for you (at SharePoint web application " +serverUrl+"):" + System.Environment.NewLine
    ...
    + "如果您想切换回中文，请发送消息 'cn'";
        ...
        private string GetSPFBAUserNamePassword()
        {
            switch (CurrentCulture.Name)
            {
                case "zh-CN":
                    return
    "电脑网站("+serverUrl+")用户名:" + SPFBAUserName + System.Environment.NewLine
    + "动态密码:" + DynamicPassword(SPFBAUserName) + System.Environment.NewLine + System.Environment.NewLine
    ...
    + "若关注公众号后始终无法用此网站账户登录网站，有可能是生成账户失败，可以尝试取消关注，再重新关注，让系统重新生成网站账户。也可在网站匿名公开留言，提醒管理员解决";
                ...
                default:
                    return
       "SharePoint ("+ serverUrl+ ") username:" + SPFBAUserName + System.Environment.NewLine
