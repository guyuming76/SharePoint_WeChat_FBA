...
namespace Sharepoint.FormsBasedAuthentication
{
    public class Utils
    {
        ...
        public static void LogError(string errorMessage, MyFBADiagnosticsService.FBADiagnosticsCategory errorCategory)
        {
            // log error to ULS log
            MyFBADiagnosticsService.Local.WriteTrace(0, errorCategory, TraceSeverity.High, errorMessage,null);
        }

        public static void LogError(Exception ex)
        {
            // log error
            LogError(ex.ToString(), MyFBADiagnosticsService.FBADiagnosticsCategory.General);
        }

        public static void LogError(string errorMessage)
        {
            LogError(errorMessage, MyFBADiagnosticsService.FBADiagnosticsCategory.General);
        }
